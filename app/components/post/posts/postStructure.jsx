...
const PostStructure = ({
 ...
 const link = `/${userId}`
  return (
    <div className="z-20 max-w-[598px] w-[598px] border-b-[1px] border-x-[1px] border-[#2f3336]">
      <div className="mx-[8px] pt-[12px] flex flex-row justify-between">
        <UserLogo logo = {userlogo} />
        
        <div className="max-w-[518px] w-[518px] bg-black">
          <div className="max-w-[518px] max-h-[20px] h-[20px] flex flex-row justify-between">
          ...
          <div className="max-h-[32px] max-w-[518px]">
            <div className="mt-[16] ">
              <div className="flex flex-row   text-sm text-[#a9a9a9]">
                ...
                <button className="max-h-[20px] w-[129.5px] hover:text-green-500 duration-150">
                  <div className="flex flex-row gap-[2px]">
                ...
                <button className="max-h-[20px] w-[129.5px] hover:text-red-500 duration-150">
                  <div className="flex flex-row gap-[2px]">
