...
const Register = ({setModalVisible ,setregisterModalVisible}) => {
  ...
  return (
   <main className="sm:max-h-[865px] sm:max-w-[375px]">
    <div className=' mr-2 bg-red-500'>
    <h1 className='text-6xl font-bold'>Happening now</h1>
    <h1 className='text-3xl font-bold'>Join today.</h1>
    <div className='flex flex-col gap-3 px-40'>
    <button className='border-[1px] border-gray-500 rounded-full text-white font-semibold hover:opacity-75 duration-150 h-10 w-[300px]'>Sign up with google</button>
    <button className='border-[1px] border-gray-500 rounded-full text-white font-semibold hover:opacity-75 duration-150 h-10  w-[300px]'>Sign up with Apple</button>
