...
const Header =  () => {
    const HeaderTop = () => {
      const session = useSession();
        return (
            <div className="message_header_top_container">
                    <Sheet >
                    <SheetTrigger asChild>
                    <button className="message_header_top_container_child1">
                    <Image
                        src={session.data?.user?.image}
                        height={32}
                        width={32}
               ...
               <div className="h-full w-9 flex flex-row items-center text-white font-bold text-lg">messages</div>
               <div className="message_header_top_container_child3"><Image src="/common/settings.svg" height={20} width={20} quality={10} /></div>
            </div>
        )
    }
  return (
