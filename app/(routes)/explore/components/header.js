      ...
      const session = useSession();
        return (
            <div className="header_top_container">
                ...
                <input type="text" className="header_top_container_childinput" value="search"/>
    ...
    <div>
      ...
      <Tabs defaultValue="foryou" className="header">
        <TabsList className ="header_container">
            ...
            <TabsTrigger value="trending" className = "header_trigger"><span className="header_trigger_child">Trending</span></TabsTrigger>
            <TabsTrigger value="news" className = "header_trigger"><span className="header_trigger_child">News</span></TabsTrigger>
            <TabsTrigger value="sports" className = "header_trigger"><span className="header_trigger_child">Sports</span></TabsTrigger>
            <TabsTrigger value="entertainment" className = "header_trigger"><span className="header_trigger_child">Entertainment</span></TabsTrigger>
        </TabsList>
        </Tabs>
    </div>
  )
